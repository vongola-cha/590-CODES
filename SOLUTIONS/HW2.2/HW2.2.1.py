...
model_type="linear";    X_KEYS=['x1','x2']; Y_KEYS=['y']; LR=0.01  #LEARNING RATE 
model_type="logistic";  X_KEYS=['x1','x2']; Y_KEYS=['y'];   LR=10

# INPUT_FILE='planar_x1_x2_x3_y.json'
# # model_type="linear";    X_KEYS=['x1','x2','x3']; Y_KEYS=['y']; LR=0.01  #LEARNING RATE 
